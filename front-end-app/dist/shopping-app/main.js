...
module.exports = "<app-navigation></app-navigation>\r\n<app-sidenav></app-sidenav>\r\n\r\n<div class=\"container\">\r\n  <div class=\"form-group\">\r\n    <div id=\"mySidenav\" class=\"sidenav\" align=\"left\">\r\n      <a href=\"javascript:void(0)\" class=\"closebtn\" onclick=\"closeNav()\">&times;</a>\r\n\r\n      <div class=\"col-3 align-left\" *ngFor=\"let productcat of productsCat\">\r\n        <li>\r\n          <a href=\"javascript:void(0)\" class=\"closebtn\"\r\n             onclick='getSearchResultsByCategory(productcat.productcatname)'>{{productcat.productcatname}}</a>\r\n        </li>\r\n      </div>\r\n    </div>\r\n    <label>Search Items:::</label>\r\n    <input type=\"text\" class=\"form-control\" name=\"title\" id=\"search\">\r\n    <button class=\"btn btn-info btn-sm\" (click)=\"getSearchResults()\">Search Item</button>\r\n  </div>\r\n\r\n  <div class=\"row\">\r\n    <div class=\"col-3 align-left\" *ngFor=\"let product of products\">\r\n      <app-product [product]=\"product\" (productAddToCart)=\"addToCart($event)\">Loading...</app-product>\r\n    </div>\r\n  </div>\r\n</div>"
...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.getSearchResultsByCategory = function (value) {
        var _this = this;
        if (this.api.isAuthenticated) {
            this.api.getSearchCategories(value).subscribe(function (res) {
                _this.products = res.oblist;
            });
            this.api.getProductsCats().subscribe(function (res) {
                _this.productsCat = res.oblist;
            });
        }
    };
    HomeComponent.prototype.getSearchResults = function () {
        var _this = this;
        if (this.api.isAuthenticated) {
            var elem = document.getElementById('search');
            var value = elem.value;
            this.api.getSearchProducts(value).subscribe(function (res) {
                _this.products = res.oblist;
            });
        }
    };
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype.getProductsCats = function () {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].productsCatUrl);
    };
    ApiService.prototype.getSearchCategories = function (value) {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].baseUrl + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].productsCatSearchUrl + "?search=" + value);
    };
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<div class=\"container head-title\">\n        <h4 class=\"display-4 text-center\">Foody !!</h4>\n        \n</div>\n\n<router-outlet></router-outlet>\n"
...
module.exports = __webpack_require__(/*! /Users/sandeepjakkaraju/CALTECH-PGP/capstone-project/front-end-app/src/main.ts */"./src/main.ts");
